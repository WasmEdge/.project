# WasmEdge Runtime `.project`

`.project` (dot-project) is a CNCF initiative to centralize and automate metadata management for all CNCF projects.
This repository holds the canonical metadata for [WasmEdge Runtime](https://wasmedge.org/) and is maintained by the CNCF automation tooling.
